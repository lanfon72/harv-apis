...
**FieldsV1** | [***K8sIoV1FieldsV1**](k8s.io.v1.FieldsV1.md) | FieldsV1 holds the first JSON version format as described in the \&quot;FieldsV1\&quot; type. | [optional] [default to null]
...
**Time** | [***K8sIoV1Time**](k8s.io.v1.Time.md) | Time is timestamp of when these fields were set. It should always be empty if Operation is &#39;Apply&#39; | [optional] [default to null]
