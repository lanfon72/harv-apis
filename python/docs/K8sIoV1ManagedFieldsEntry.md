...
**fields_v1** | [**K8sIoV1FieldsV1**](K8sIoV1FieldsV1.md) | FieldsV1 holds the first JSON version format as described in the \&quot;FieldsV1\&quot; type. | [optional] 
...
**time** | [**K8sIoV1Time**](K8sIoV1Time.md) | Time is timestamp of when these fields were set. It should always be empty if Operation is &#39;Apply&#39; | [optional] 
