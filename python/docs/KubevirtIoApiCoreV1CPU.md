...
**features** | [**list[KubevirtIoApiCoreV1CPUFeature]**](KubevirtIoApiCoreV1CPUFeature.md) | Features specifies the CPU features list inside the VMI. | [optional] 
...
**numa** | [**KubevirtIoApiCoreV1NUMA**](KubevirtIoApiCoreV1NUMA.md) | NUMA allows specifying settings for the guest NUMA topology | [optional] 
**realtime** | [**KubevirtIoApiCoreV1Realtime**](KubevirtIoApiCoreV1Realtime.md) | Realtime instructs the virt-launcher to tune the VMI for lower latency, optional for real time workloads | [optional] 
