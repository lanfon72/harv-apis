...
class RestoresApi(object):
    ...
    def create_namespaced_virtual_machine_restore(self, namespace, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_namespaced_virtual_machine_restore(namespace, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str namespace: Object name and auth scope, such as for teams and projects (required)
        :param HarvesterhciIoV1beta1VirtualMachineRestore body: (required)
        ...
        if kwargs.get('async_req'):
            return self.create_namespaced_virtual_machine_restore_with_http_info(namespace, body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_namespaced_virtual_machine_restore_with_http_info(namespace, body, **kwargs)  # noqa: E501
            return data

    def create_namespaced_virtual_machine_restore_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        """create_namespaced_virtual_machine_restore  # noqa: E501

        Create a VirtualMachineRestore object.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_namespaced_virtual_machine_restore_with_http_info(namespace, body, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/apis/harvesterhci.io/v1beta1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinerestores', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='HarvesterhciIoV1beta1VirtualMachineRestore',  # noqa: E501
    ...
    def delete_namespaced_virtual_machine_restore_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/harvesterhci.io/v1beta1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinerestores/{name:[a-z0-9][a-z0-9\-]*}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_namespaced_virtual_machine_restore(self, namespace, **kwargs):  # noqa: E501
        ...
        Get a list of VirtualMachineRestore objects in a namespace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_namespaced_virtual_machine_restore_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/harvesterhci.io/v1beta1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinerestores', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='HarvesterhciIoV1beta1VirtualMachineRestoreList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_virtual_machine_restore_for_all_namespaces_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/harvesterhci.io/v1beta1/virtualmachinerestores', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def patch_namespaced_virtual_machine_restore_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/harvesterhci.io/v1beta1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinerestores/{name:[a-z0-9][a-z0-9\-]*}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_namespaced_virtual_machine_restore_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/harvesterhci.io/v1beta1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinerestores/{name:[a-z0-9][a-z0-9\-]*}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_namespaced_virtual_machine_restore_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/harvesterhci.io/v1beta1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinerestores/{name:[a-z0-9][a-z0-9\-]*}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
